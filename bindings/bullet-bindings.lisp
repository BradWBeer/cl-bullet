...
(cffi:defcfun ("_wrap_btVector3_btdot" btVector3_btdot) :float
  (self :pointer)
  (v :pointer))
...
(cffi:defcfun ("_wrap_btVector3_getX" btVector3_getX) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btVector3_getY" btVector3_getY) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btVector3_getZ" btVector3_getZ) :float
  (self :pointer))
...
(cffi:defcfun ("_wrap_btVector3_x" btVector3_x) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btVector3_y" btVector3_y) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btVector3_z" btVector3_z) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btVector3_w" btVector3_w) :float
  (self :pointer))
...
(cffi:defcfun ("_wrap_btQuadWord_getX" btQuadWord_getX) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btQuadWord_getY" btQuadWord_getY) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btQuadWord_getZ" btQuadWord_getZ) :float
  (self :pointer))
...
(cffi:defcfun ("_wrap_btQuadWord_x" btQuadWord_x) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btQuadWord_y" btQuadWord_y) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btQuadWord_z" btQuadWord_z) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btQuadWord_w" btQuadWord_w) :float
  (self :pointer))
...
(cffi:defcfun ("_wrap_new_btQuadWord_xyz" new_btQuadWord_xyz) :pointer
  (_x :float)
  (_y :float)
  (_z :float))

(cffi:defcfun ("_wrap_new_btQuadWord_xyzw" new_btQuadWord_xyzw) :pointer
  (_x :float)
  (_y :float)
  (_z :float)
  (_w :float))
...
(cffi:defcfun ("_wrap_new_btQuaternion" new_btQuaternion) :pointer
  (_axis :pointer)
  (_angle :float))

(cffi:defcfun ("_wrap_new_btQuaternion_from_3btScalars" new_btQuaternion_from_3btScalars) :pointer
  (yaw :float)
  (pitch :float)
  (roll :float))
...
(cffi:defcfun ("_wrap_btQuaternion_btdot" btQuaternion_btdot) :float
  (self :pointer)
  (q :pointer))
...
(cffi:defcfun ("_wrap_btQuaternion_getW" btQuaternion_getW) :float
  (self :pointer))
...
(cffi:defcstruct btBroadphaseProxy
	(_ :pointer)
	(_ :pointer)
	(_ :pointer)
	(_ :pointer)
	...
	(m_collisionFilterGroup :short)
	(m_collisionFilterMask :short)
	(m_multiSapParentProxy :pointer)
	(m_uniqueId :int)
	(m_aabbMin :pointer)
	(m_aabbMax :pointer)
	(getUid :pointer)
	(isPolyhedral :pointer)
	(isConvex :pointer)
	(isNonMoving :pointer)
	(isConcave :pointer)
	(isCompound :pointer)
...
(cffi:defcstruct btBroadphasePair
	(_ :pointer)
	(_ :pointer)
	(_ :pointer)
	(_ :pointer)
...
(cffi:defcstruct btDbvtBroadphase
	(m_sets :pointer)
	...
	(aabbTest :pointer)
	(getAabb :pointer)
	(calculateOverlappingPairs :pointer)
	(getOverlappingPairCache :pointer)
	(getOverlappingPairCache :pointer)
	(getBroadphaseAabb :pointer)
	(printStats :pointer)
	(resetPool :pointer)
	(performDeferredRemoval :pointer)
	(setVelocityPrediction :pointer)
	(getVelocityPrediction :pointer)
	(setAabbForceUpdate :pointer)
	(benchmark :pointer))

(cffi:defcstruct btDispatcherInfo
	(m_timeStep :float)
	(m_stepCount :int)
	(m_dispatchFunc :int)
	(m_timeOfImpact :float)
	(m_useContinuous :pointer)
	(m_debugDraw :pointer)
	(m_enableSatConvex :pointer)
	(m_enableSPU :pointer)
	(m_useEpa :pointer)
	(m_allowedCcdPenetration :float)
	(m_useConvexConservativeDistanceUtil :pointer)
	(m_convexConservativeDistanceThreshold :float))
...
(cffi:defcfun ("_wrap_btStaticPlaneShape_getPlaneConstant" btStaticPlaneShape_getPlaneConstant) :float
  (self :pointer))
...
(cffi:defcstruct btSoftBodyWorldInfo
	...
	(water_normal :pointer)
	(m_broadphase :pointer)
	(m_dispatcher :pointer)
	(m_gravity :pointer)
	(m_sparsesdf :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_collisionDisabledObjects_set" btSoftBody_m_collisionDisabledObjects_set) :void
  (self :pointer)
  (m_collisionDisabledObjects :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_collisionDisabledObjects_get" btSoftBody_m_collisionDisabledObjects_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_softBodySolver_set" btSoftBody_m_softBodySolver_set) :void
  (self :pointer)
  (m_softBodySolver :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_softBodySolver_get" btSoftBody_m_softBodySolver_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_cfg_set" btSoftBody_m_cfg_set) :void
  (self :pointer)
  (m_cfg :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_cfg_get" btSoftBody_m_cfg_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_sst_set" btSoftBody_m_sst_set) :void
  (self :pointer)
  (m_sst :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_sst_get" btSoftBody_m_sst_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_pose_set" btSoftBody_m_pose_set) :void
  (self :pointer)
  (m_pose :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_pose_get" btSoftBody_m_pose_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_tag_set" btSoftBody_m_tag_set) :void
  (self :pointer)
  (m_tag :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_tag_get" btSoftBody_m_tag_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_worldInfo_set" btSoftBody_m_worldInfo_set) :void
  (self :pointer)
  (m_worldInfo :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_worldInfo_get" btSoftBody_m_worldInfo_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_notes_set" btSoftBody_m_notes_set) :void
  (self :pointer)
  (m_notes :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_notes_get" btSoftBody_m_notes_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_nodes_set" btSoftBody_m_nodes_set) :void
  (self :pointer)
  (m_nodes :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_nodes_get" btSoftBody_m_nodes_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_links_set" btSoftBody_m_links_set) :void
  (self :pointer)
  (m_links :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_links_get" btSoftBody_m_links_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_faces_set" btSoftBody_m_faces_set) :void
  (self :pointer)
  (m_faces :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_faces_get" btSoftBody_m_faces_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_tetras_set" btSoftBody_m_tetras_set) :void
  (self :pointer)
  (m_tetras :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_tetras_get" btSoftBody_m_tetras_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_anchors_set" btSoftBody_m_anchors_set) :void
  (self :pointer)
  (m_anchors :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_anchors_get" btSoftBody_m_anchors_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_rcontacts_set" btSoftBody_m_rcontacts_set) :void
  (self :pointer)
  (m_rcontacts :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_rcontacts_get" btSoftBody_m_rcontacts_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_scontacts_set" btSoftBody_m_scontacts_set) :void
  (self :pointer)
  (m_scontacts :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_scontacts_get" btSoftBody_m_scontacts_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_joints_set" btSoftBody_m_joints_set) :void
  (self :pointer)
  (m_joints :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_joints_get" btSoftBody_m_joints_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_materials_set" btSoftBody_m_materials_set) :void
  (self :pointer)
  (m_materials :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_materials_get" btSoftBody_m_materials_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_timeacc_set" btSoftBody_m_timeacc_set) :void
  (self :pointer)
  (m_timeacc :float))

(cffi:defcfun ("_wrap_btSoftBody_m_timeacc_get" btSoftBody_m_timeacc_get) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_bounds_set" btSoftBody_m_bounds_set) :void
  (self :pointer)
  (m_bounds :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_bounds_get" btSoftBody_m_bounds_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_bUpdateRtCst_set" btSoftBody_m_bUpdateRtCst_set) :void
  (self :pointer)
  (m_bUpdateRtCst :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_bUpdateRtCst_get" btSoftBody_m_bUpdateRtCst_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_clusters_set" btSoftBody_m_clusters_set) :void
  (self :pointer)
  (m_clusters :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_clusters_get" btSoftBody_m_clusters_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_clusterConnectivity_set" btSoftBody_m_clusterConnectivity_set) :void
  (self :pointer)
  (m_clusterConnectivity :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_clusterConnectivity_get" btSoftBody_m_clusterConnectivity_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_initialWorldTransform_set" btSoftBody_m_initialWorldTransform_set) :void
  (self :pointer)
  (m_initialWorldTransform :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_initialWorldTransform_get" btSoftBody_m_initialWorldTransform_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_windVelocity_set" btSoftBody_m_windVelocity_set) :void
  (self :pointer)
  (m_windVelocity :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_windVelocity_get" btSoftBody_m_windVelocity_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_restLengthScale_set" btSoftBody_m_restLengthScale_set) :void
  (self :pointer)
  (m_restLengthScale :float))

(cffi:defcfun ("_wrap_btSoftBody_m_restLengthScale_get" btSoftBody_m_restLengthScale_get) :float
  (self :pointer))

(cffi:defcfun ("_wrap_new_btSoftBody__SWIG_0" new_btSoftBody) :pointer
  (worldInfo :pointer)
  (node_count :int)
  (x :pointer)
  (m :pointer))

(cffi:defcfun ("_wrap_new_btSoftBody__SWIG_1" new_btSoftBody) :pointer
  (worldInfo :pointer))

(cffi:defcfun ("_wrap_btSoftBody_initDefaults" btSoftBody_initDefaults) :void
  (self :pointer))

(cffi:defcfun ("_wrap_delete_btSoftBody" delete_btSoftBody) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_userIndexMapping_set" btSoftBody_m_userIndexMapping_set) :void
  (self :pointer)
  (m_userIndexMapping :pointer))

(cffi:defcfun ("_wrap_btSoftBody_m_userIndexMapping_get" btSoftBody_m_userIndexMapping_get) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_getWorldInfo" btSoftBody_getWorldInfo) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_setCollisionShape" btSoftBody_setCollisionShape) :void
  (self :pointer)
  (collisionShape :pointer))

(cffi:defcfun ("_wrap_btSoftBody_checkLink__SWIG_0" btSoftBody_checkLink) :pointer
  (self :pointer)
  (node0 :int)
  (node1 :int))

(cffi:defcfun ("_wrap_btSoftBody_checkLink__SWIG_1" btSoftBody_checkLink) :pointer
  (self :pointer)
  (node0 :pointer)
  (node1 :pointer))

(cffi:defcfun ("_wrap_btSoftBody_checkFace" btSoftBody_checkFace) :pointer
  (self :pointer)
  (node0 :int)
  (node1 :int)
  (node2 :int))

(cffi:defcfun ("_wrap_btSoftBody_appendMaterial" btSoftBody_appendMaterial) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_0" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer)
  (c :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_1" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer)
  (c :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_2" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer)
  (c :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_3" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer)
  (c :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_4" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer)
  (c :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_5" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_6" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer)
  (feature :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_7" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer)
  (feature :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendNote__SWIG_8" btSoftBody_appendNote) :void
  (self :pointer)
  (text :string)
  (o :pointer)
  (feature :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendNode" btSoftBody_appendNode) :void
  (self :pointer)
  (x :pointer)
  (m :float))

(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_0" btSoftBody_appendLink) :void
  (self :pointer)
  (model :int)
  (mat :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_1" btSoftBody_appendLink) :void
  (self :pointer)
  (model :int))

(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_2" btSoftBody_appendLink) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_3" btSoftBody_appendLink) :void
  (self :pointer)
  (node0 :int)
  (node1 :int)
  (mat :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_4" btSoftBody_appendLink) :void
  (self :pointer)
  (node0 :int)
  (node1 :int)
  (mat :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_5" btSoftBody_appendLink) :void
  (self :pointer)
  (node0 :int)
  (node1 :int))

(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_6" btSoftBody_appendLink) :void
  (self :pointer)
  (node0 :pointer)
  (node1 :pointer)
  (mat :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_7" btSoftBody_appendLink) :void
  (self :pointer)
  (node0 :pointer)
  (node1 :pointer)
  (mat :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendLink__SWIG_8" btSoftBody_appendLink) :void
  (self :pointer)
  (node0 :pointer)
  (node1 :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendFace__SWIG_0" btSoftBody_appendFace) :void
  (self :pointer)
  (model :int)
  (mat :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendFace__SWIG_1" btSoftBody_appendFace) :void
  (self :pointer)
  (model :int))

(cffi:defcfun ("_wrap_btSoftBody_appendFace__SWIG_2" btSoftBody_appendFace) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendFace__SWIG_3" btSoftBody_appendFace) :void
  (self :pointer)
  (node0 :int)
  (node1 :int)
  (node2 :int)
...
(cffi:defcfun ("_wrap_btSoftBody_appendFace__SWIG_4" btSoftBody_appendFace) :void
  (self :pointer)
  (node0 :int)
  (node1 :int)
  (node2 :int))

(cffi:defcfun ("_wrap_btSoftBody_appendTetra__SWIG_0" btSoftBody_appendTetra) :void
  (self :pointer)
  (model :int)
  (mat :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendTetra__SWIG_1" btSoftBody_appendTetra) :void
  (self :pointer)
  (node0 :int)
  (node1 :int)
  (node2 :int)
...
(cffi:defcfun ("_wrap_btSoftBody_appendTetra__SWIG_2" btSoftBody_appendTetra) :void
  (self :pointer)
  (node0 :int)
  (node1 :int)
  (node2 :int)
...
(cffi:defcfun ("_wrap_btSoftBody_appendAnchor__SWIG_0" btSoftBody_appendAnchor) :void
  (self :pointer)
  (node :int)
  (body :pointer)
  (disableCollisionBetweenLinkedBodies :pointer)
  (influence :float))

(cffi:defcfun ("_wrap_btSoftBody_appendAnchor__SWIG_1" btSoftBody_appendAnchor) :void
  (self :pointer)
  (node :int)
  (body :pointer)
  (disableCollisionBetweenLinkedBodies :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendAnchor__SWIG_2" btSoftBody_appendAnchor) :void
  (self :pointer)
  (node :int)
  (body :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendAnchor__SWIG_3" btSoftBody_appendAnchor) :void
  (self :pointer)
  (node :int)
  (body :pointer)
  (localPivot :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_appendAnchor__SWIG_4" btSoftBody_appendAnchor) :void
  (self :pointer)
  (node :int)
  (body :pointer)
  (localPivot :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_appendAnchor__SWIG_5" btSoftBody_appendAnchor) :void
  (self :pointer)
  (node :int)
  (body :pointer)
  (localPivot :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendLinearJoint__SWIG_0" btSoftBody_appendLinearJoint) :void
  (self :pointer)
  (specs :pointer)
  (body0 :pointer)
  (body1 :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendLinearJoint__SWIG_1" btSoftBody_appendLinearJoint) :void
  (self :pointer)
  (specs :pointer)
  (body :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendLinearJoint__SWIG_2" btSoftBody_appendLinearJoint) :void
  (self :pointer)
  (specs :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendLinearJoint__SWIG_3" btSoftBody_appendLinearJoint) :void
  (self :pointer)
  (specs :pointer)
  (body :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendAngularJoint__SWIG_0" btSoftBody_appendAngularJoint) :void
  (self :pointer)
  (specs :pointer)
  (body0 :pointer)
  (body1 :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendAngularJoint__SWIG_1" btSoftBody_appendAngularJoint) :void
  (self :pointer)
  (specs :pointer)
  (body :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendAngularJoint__SWIG_2" btSoftBody_appendAngularJoint) :void
  (self :pointer)
  (specs :pointer))

(cffi:defcfun ("_wrap_btSoftBody_appendAngularJoint__SWIG_3" btSoftBody_appendAngularJoint) :void
  (self :pointer)
  (specs :pointer)
  (body :pointer))

(cffi:defcfun ("_wrap_btSoftBody_addForce__SWIG_0" btSoftBody_addForce) :void
  (self :pointer)
  (force :pointer))

(cffi:defcfun ("_wrap_btSoftBody_addForce__SWIG_1" btSoftBody_addForce) :void
  (self :pointer)
  (force :pointer)
  (node :int))

(cffi:defcfun ("_wrap_btSoftBody_addAeroForceToNode" btSoftBody_addAeroForceToNode) :void
  (self :pointer)
  (windVelocity :pointer)
  (nodeIndex :int))

(cffi:defcfun ("_wrap_btSoftBody_addAeroForceToFace" btSoftBody_addAeroForceToFace) :void
  (self :pointer)
  (windVelocity :pointer)
  (faceIndex :int))

(cffi:defcfun ("_wrap_btSoftBody_addVelocity__SWIG_0" btSoftBody_addVelocity) :void
  (self :pointer)
  (velocity :pointer))

(cffi:defcfun ("_wrap_btSoftBody_setVelocity" btSoftBody_setVelocity) :void
  (self :pointer)
  (velocity :pointer))

(cffi:defcfun ("_wrap_btSoftBody_addVelocity__SWIG_1" btSoftBody_addVelocity) :void
  (self :pointer)
  (velocity :pointer)
  (node :int))

(cffi:defcfun ("_wrap_btSoftBody_setMass" btSoftBody_setMass) :void
  (self :pointer)
  (node :int)
  (mass :float))

(cffi:defcfun ("_wrap_btSoftBody_getMass" btSoftBody_getMass) :float
  (self :pointer)
  (node :int))

(cffi:defcfun ("_wrap_btSoftBody_getTotalMass" btSoftBody_getTotalMass) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_setTotalMass__SWIG_0" btSoftBody_setTotalMass) :void
  (self :pointer)
  (mass :float)
  (fromfaces :pointer))

(cffi:defcfun ("_wrap_btSoftBody_setTotalMass__SWIG_1" btSoftBody_setTotalMass) :void
  (self :pointer)
  (mass :float))

(cffi:defcfun ("_wrap_btSoftBody_setTotalDensity" btSoftBody_setTotalDensity) :void
  (self :pointer)
  (density :float))

(cffi:defcfun ("_wrap_btSoftBody_setVolumeMass" btSoftBody_setVolumeMass) :void
  (self :pointer)
  (mass :float))

(cffi:defcfun ("_wrap_btSoftBody_setVolumeDensity" btSoftBody_setVolumeDensity) :void
  (self :pointer)
  (density :float))

(cffi:defcfun ("_wrap_btSoftBody_transform" btSoftBody_transform) :void
  (self :pointer)
  (trs :pointer))

(cffi:defcfun ("_wrap_btSoftBody_translate" btSoftBody_translate) :void
  (self :pointer)
  (trs :pointer))

(cffi:defcfun ("_wrap_btSoftBody_rotate" btSoftBody_rotate) :void
  (self :pointer)
  (rot :pointer))

(cffi:defcfun ("_wrap_btSoftBody_scale" btSoftBody_scale) :void
  (self :pointer)
  (scl :pointer))

(cffi:defcfun ("_wrap_btSoftBody_getRestLengthScale" btSoftBody_getRestLengthScale) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_setRestLengthScale" btSoftBody_setRestLengthScale) :void
  (self :pointer)
  (restLength :float))

(cffi:defcfun ("_wrap_btSoftBody_setPose" btSoftBody_setPose) :void
  (self :pointer)
  (bvolume :pointer)
  (bframe :pointer))

(cffi:defcfun ("_wrap_btSoftBody_resetLinkRestLengths" btSoftBody_resetLinkRestLengths) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_getVolume" btSoftBody_getVolume) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterCount" btSoftBody_clusterCount) :int
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterCom__SWIG_0" btSoftBody_clusterCom) :pointer
  (cluster :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterCom__SWIG_1" btSoftBody_clusterCom) :pointer
  (self :pointer)
  (cluster :int))

(cffi:defcfun ("_wrap_btSoftBody_clusterVelocity" btSoftBody_clusterVelocity) :pointer
  (cluster :pointer)
  (rpos :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterVImpulse" btSoftBody_clusterVImpulse) :void
  (cluster :pointer)
  (rpos :pointer)
  (impulse :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterDImpulse" btSoftBody_clusterDImpulse) :void
  (cluster :pointer)
  (rpos :pointer)
  (impulse :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterImpulse" btSoftBody_clusterImpulse) :void
  (cluster :pointer)
  (rpos :pointer)
  (impulse :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterVAImpulse" btSoftBody_clusterVAImpulse) :void
  (cluster :pointer)
  (impulse :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterDAImpulse" btSoftBody_clusterDAImpulse) :void
  (cluster :pointer)
  (impulse :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterAImpulse" btSoftBody_clusterAImpulse) :void
  (cluster :pointer)
  (impulse :pointer))

(cffi:defcfun ("_wrap_btSoftBody_clusterDCImpulse" btSoftBody_clusterDCImpulse) :void
  (cluster :pointer)
  (impulse :pointer))

(cffi:defcfun ("_wrap_btSoftBody_generateBendingConstraints__SWIG_0" btSoftBody_generateBendingConstraints) :int
  (self :pointer)
  (distance :int)
  (mat :pointer))

(cffi:defcfun ("_wrap_btSoftBody_generateBendingConstraints__SWIG_1" btSoftBody_generateBendingConstraints) :int
  (self :pointer)
  (distance :int))

(cffi:defcfun ("_wrap_btSoftBody_randomizeConstraints" btSoftBody_randomizeConstraints) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_releaseCluster" btSoftBody_releaseCluster) :void
  (self :pointer)
  (index :int))

(cffi:defcfun ("_wrap_btSoftBody_releaseClusters" btSoftBody_releaseClusters) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_generateClusters__SWIG_0" btSoftBody_generateClusters) :int
  (self :pointer)
  (k :int)
  (maxiterations :int))

(cffi:defcfun ("_wrap_btSoftBody_generateClusters__SWIG_1" btSoftBody_generateClusters) :int
  (self :pointer)
  (k :int))

(cffi:defcfun ("_wrap_btSoftBody_refine" btSoftBody_refine) :void
  (self :pointer)
  (ifn :pointer)
  (accurary :float)
  (cut :pointer))

(cffi:defcfun ("_wrap_btSoftBody_cutLink__SWIG_0" btSoftBody_cutLink) :pointer
  (self :pointer)
  (node0 :int)
  (node1 :int)
  (position :float))

(cffi:defcfun ("_wrap_btSoftBody_cutLink__SWIG_1" btSoftBody_cutLink) :pointer
  (self :pointer)
  (node0 :pointer)
  (node1 :pointer)
  (position :float))

(cffi:defcfun ("_wrap_btSoftBody_rayTest__SWIG_0" btSoftBody_rayTest) :pointer
  (self :pointer)
  (rayFrom :pointer)
  (rayTo :pointer)
  (results :pointer))

(cffi:defcfun ("_wrap_btSoftBody_setSolver" btSoftBody_setSolver) :void
  (self :pointer)
  (preset :pointer))

(cffi:defcfun ("_wrap_btSoftBody_predictMotion" btSoftBody_predictMotion) :void
  (self :pointer)
  (dt :float))

(cffi:defcfun ("_wrap_btSoftBody_solveConstraints" btSoftBody_solveConstraints) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_staticSolve" btSoftBody_staticSolve) :void
  (self :pointer)
  (iterations :int))

(cffi:defcfun ("_wrap_btSoftBody_solveCommonConstraints" btSoftBody_solveCommonConstraints) :void
  (bodies :pointer)
  (count :int)
  (iterations :int))

(cffi:defcfun ("_wrap_btSoftBody_solveClusters__SWIG_0" btSoftBody_solveClusters) :void
  (bodies :pointer))

(cffi:defcfun ("_wrap_btSoftBody_integrateMotion" btSoftBody_integrateMotion) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_defaultCollisionHandler__SWIG_0" btSoftBody_defaultCollisionHandler) :void
  (self :pointer)
  (pcoWrap :pointer))

(cffi:defcfun ("_wrap_btSoftBody_defaultCollisionHandler__SWIG_1" btSoftBody_defaultCollisionHandler) :void
  (self :pointer)
  (psb :pointer))

(cffi:defcfun ("_wrap_btSoftBody_setWindVelocity" btSoftBody_setWindVelocity) :void
  (self :pointer)
  (velocity :pointer))

(cffi:defcfun ("_wrap_btSoftBody_getWindVelocity" btSoftBody_getWindVelocity) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_setSoftBodySolver" btSoftBody_setSoftBodySolver) :void
  (self :pointer)
  (softBodySolver :pointer))

(cffi:defcfun ("_wrap_btSoftBody_getSoftBodySolver__SWIG_0" btSoftBody_getSoftBodySolver) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_getSoftBodySolver__SWIG_1" btSoftBody_getSoftBodySolver) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_upcast__SWIG_0" btSoftBody_upcast) :pointer
  (colObj :pointer))

(cffi:defcfun ("_wrap_btSoftBody_upcast__SWIG_1" btSoftBody_upcast) :pointer
  (colObj :pointer))

(cffi:defcfun ("_wrap_btSoftBody_getAabb" btSoftBody_getAabb) :void
  (self :pointer)
  (aabbMin :pointer)
  (aabbMax :pointer))

(cffi:defcfun ("_wrap_btSoftBody_pointersToIndices" btSoftBody_pointersToIndices) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_indicesToPointers__SWIG_0" btSoftBody_indicesToPointers) :void
  (self :pointer)
  (map :pointer))

(cffi:defcfun ("_wrap_btSoftBody_indicesToPointers__SWIG_1" btSoftBody_indicesToPointers) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_rayTest__SWIG_1" btSoftBody_rayTest) :int
  (self :pointer)
  (rayFrom :pointer)
  (rayTo :pointer)
  (mint :pointer)
...
(cffi:defcfun ("_wrap_btSoftBody_initializeFaceTree" btSoftBody_initializeFaceTree) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_evaluateCom" btSoftBody_evaluateCom) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_checkContact" btSoftBody_checkContact) :pointer
  (self :pointer)
  (colObjWrap :pointer)
  (x :pointer)
  (margin :float)
...
(cffi:defcfun ("_wrap_btSoftBody_updateNormals" btSoftBody_updateNormals) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_updateBounds" btSoftBody_updateBounds) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_updatePose" btSoftBody_updatePose) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_updateConstants" btSoftBody_updateConstants) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_updateLinkConstants" btSoftBody_updateLinkConstants) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_updateArea__SWIG_0" btSoftBody_updateArea) :void
  (self :pointer)
  (averageArea :pointer))

(cffi:defcfun ("_wrap_btSoftBody_updateArea__SWIG_1" btSoftBody_updateArea) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_initializeClusters" btSoftBody_initializeClusters) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_updateClusters" btSoftBody_updateClusters) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_cleanupClusters" btSoftBody_cleanupClusters) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_prepareClusters" btSoftBody_prepareClusters) :void
  (self :pointer)
  (iterations :int))

(cffi:defcfun ("_wrap_btSoftBody_solveClusters__SWIG_1" btSoftBody_solveClusters) :void
  (self :pointer)
  (sor :float))

(cffi:defcfun ("_wrap_btSoftBody_applyClusters" btSoftBody_applyClusters) :void
  (self :pointer)
  (drift :pointer))

(cffi:defcfun ("_wrap_btSoftBody_dampClusters" btSoftBody_dampClusters) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_applyForces" btSoftBody_applyForces) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_PSolve_Anchors" btSoftBody_PSolve_Anchors) :void
  (psb :pointer)
  (kst :float)
  (ti :float))

(cffi:defcfun ("_wrap_btSoftBody_PSolve_RContacts" btSoftBody_PSolve_RContacts) :void
  (psb :pointer)
  (kst :float)
  (ti :float))

(cffi:defcfun ("_wrap_btSoftBody_PSolve_SContacts" btSoftBody_PSolve_SContacts) :void
  (psb :pointer)
  (arg1 :float)
  (ti :float))

(cffi:defcfun ("_wrap_btSoftBody_PSolve_Links" btSoftBody_PSolve_Links) :void
  (psb :pointer)
  (kst :float)
  (ti :float))

(cffi:defcfun ("_wrap_btSoftBody_VSolve_Links" btSoftBody_VSolve_Links) :void
  (psb :pointer)
  (kst :float))

(cffi:defcfun ("_wrap_btSoftBody_getSolver__SWIG_0" btSoftBody_getSolver) :pointer
  (solver :pointer))

(cffi:defcfun ("_wrap_btSoftBody_getSolver__SWIG_1" btSoftBody_getSolver) :pointer
  (solver :pointer))

(cffi:defcfun ("_wrap_btSoftBody_calculateSerializeBufferSize" btSoftBody_calculateSerializeBufferSize) :int
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBody_serialize" btSoftBody_serialize) :string
  (self :pointer)
  (dataBuffer :pointer)
  (serializer :pointer))
...
(cffi:defcfun ("_wrap_delete_btSoftBodySolver" delete_btSoftBodySolver) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_getSolverType" btSoftBodySolver_getSolverType) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_checkInitialized" btSoftBodySolver_checkInitialized) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_optimize__SWIG_0" btSoftBodySolver_optimize) :void
  (self :pointer)
  (softBodies :pointer)
  (forceUpdate :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_optimize__SWIG_1" btSoftBodySolver_optimize) :void
  (self :pointer)
  (softBodies :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_copyBackToSoftBodies__SWIG_0" btSoftBodySolver_copyBackToSoftBodies) :void
  (self :pointer)
  (bMove :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_copyBackToSoftBodies__SWIG_1" btSoftBodySolver_copyBackToSoftBodies) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_predictMotion" btSoftBodySolver_predictMotion) :void
  (self :pointer)
  (solverdt :float))

(cffi:defcfun ("_wrap_btSoftBodySolver_solveConstraints" btSoftBodySolver_solveConstraints) :void
  (self :pointer)
  (solverdt :float))

(cffi:defcfun ("_wrap_btSoftBodySolver_updateSoftBodies" btSoftBodySolver_updateSoftBodies) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_processCollision__SWIG_0" btSoftBodySolver_processCollision) :void
  (self :pointer)
  (arg1 :pointer)
  (arg2 :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_processCollision__SWIG_1" btSoftBodySolver_processCollision) :void
  (self :pointer)
  (arg1 :pointer)
  (arg2 :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_setNumberOfPositionIterations" btSoftBodySolver_setNumberOfPositionIterations) :void
  (self :pointer)
  (iterations :int))

(cffi:defcfun ("_wrap_btSoftBodySolver_getNumberOfPositionIterations" btSoftBodySolver_getNumberOfPositionIterations) :int
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_setNumberOfVelocityIterations" btSoftBodySolver_setNumberOfVelocityIterations) :void
  (self :pointer)
  (iterations :int))

(cffi:defcfun ("_wrap_btSoftBodySolver_getNumberOfVelocityIterations" btSoftBodySolver_getNumberOfVelocityIterations) :int
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolver_getTimeScale" btSoftBodySolver_getTimeScale) :float
  (self :pointer))

(cffi:defcfun ("_wrap_delete_btSoftBodySolverOutput" delete_btSoftBodySolverOutput) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btSoftBodySolverOutput_copySoftBodyToVertexBuffer" btSoftBodySolverOutput_copySoftBodyToVertexBuffer) :void
  (self :pointer)
  (softBody :pointer)
  (vertexBuffer :pointer))

(cffi:defcfun ("_wrap_new_btDefaultSoftBodySolver" new_btDefaultSoftBodySolver) :pointer)

(cffi:defcfun ("_wrap_delete_btDefaultSoftBodySolver" delete_btDefaultSoftBodySolver) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_getSolverType" btDefaultSoftBodySolver_getSolverType) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_checkInitialized" btDefaultSoftBodySolver_checkInitialized) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_updateSoftBodies" btDefaultSoftBodySolver_updateSoftBodies) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_optimize__SWIG_0" btDefaultSoftBodySolver_optimize) :void
  (self :pointer)
  (softBodies :pointer)
  (forceUpdate :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_optimize__SWIG_1" btDefaultSoftBodySolver_optimize) :void
  (self :pointer)
  (softBodies :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_copyBackToSoftBodies__SWIG_0" btDefaultSoftBodySolver_copyBackToSoftBodies) :void
  (self :pointer)
  (bMove :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_copyBackToSoftBodies__SWIG_1" btDefaultSoftBodySolver_copyBackToSoftBodies) :void
  (self :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_solveConstraints" btDefaultSoftBodySolver_solveConstraints) :void
  (self :pointer)
  (solverdt :float))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_predictMotion" btDefaultSoftBodySolver_predictMotion) :void
  (self :pointer)
  (solverdt :float))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_copySoftBodyToVertexBuffer" btDefaultSoftBodySolver_copySoftBodyToVertexBuffer) :void
  (self :pointer)
  (softBody :pointer)
  (vertexBuffer :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_processCollision__SWIG_0" btDefaultSoftBodySolver_processCollision) :void
  (self :pointer)
  (arg1 :pointer)
  (arg2 :pointer))

(cffi:defcfun ("_wrap_btDefaultSoftBodySolver_processCollision__SWIG_1" btDefaultSoftBodySolver_processCollision) :void
  (self :pointer)
  (arg1 :pointer)
  (arg2 :pointer))

(cffi:defcstruct fDrawFlags)

(cffi:defcstruct btSoftBodyHelpers
	(Draw :pointer)
	(Draw :pointer)
	(DrawInfos :pointer)
	(DrawNodeTree :pointer)
	(DrawNodeTree :pointer)
	(DrawNodeTree :pointer)
	(DrawFaceTree :pointer)
	(DrawFaceTree :pointer)
	(DrawFaceTree :pointer)
	(DrawClusterTree :pointer)
	(DrawClusterTree :pointer)
	(DrawClusterTree :pointer)
	(DrawFrame :pointer)
	(CreateRope :pointer)
	(CreatePatch :pointer)
	(CreatePatchUV :pointer)
	(CreatePatchUV :pointer)
	(CalculateUV :pointer)
	(CreateEllipsoid :pointer)
	(CreateFromTriMesh :pointer)
	(CreateFromTriMesh :pointer)
	(CreateFromConvexHull :pointer)
	(CreateFromConvexHull :pointer)
	(CreateFromTetGenData :pointer))
...
(cffi:defcstruct btSparseSdf3
	...
	(Initialize :pointer)
	(Reset :pointer)
	(GarbageCollect :pointer)
	(GarbageCollect :pointer)
	(RemoveReferences :pointer)
	(Evaluate :pointer)
	(BuildCell :pointer)
	(DistanceToShape :pointer)
	(Decompose :pointer)
	(Lerp :pointer)
	(Hash :pointer))
